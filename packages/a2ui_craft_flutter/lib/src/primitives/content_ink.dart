...
class ContentInk extends InheritedWidget {
  const ContentInk({super.key, required this.color, required super.child});

  final Color color;

  static Color? of(BuildContext context) =>
      context.dependOnInheritedWidgetOfExactType<ContentInk>()?.color;

  @override
  bool updateShouldNotify(ContentInk oldWidget) => color != oldWidget.color;
}
