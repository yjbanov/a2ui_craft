...
| **E** | Business-logic drivers (mini-apps) | ✅ Phase 1 built (`packages/a2ui_craft_logic`, the `cart` mini-app, both runners). **Next: write `PHASE_2_PLAN.md`** for the reactive framework — that is Phase 1's stated exit criterion (`REACTIVE_FRAMEWORK.md` §9) |
