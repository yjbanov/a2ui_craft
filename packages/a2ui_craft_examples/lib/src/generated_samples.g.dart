...
SampleSpec boxesSpec(String framework) => rawSamples[2].toSpec(framework);
SampleSpec layoutSpec(String framework) => rawSamples[3].toSpec(framework);
SampleSpec contactCardSpec(String framework) => rawSamples[4].toSpec(framework);
SampleSpec statsCardSpec(String framework) => rawSamples[5].toSpec(framework);
SampleSpec profileCardSpec(String framework) => rawSamples[6].toSpec(framework);
SampleSpec gallerySpec(String framework) => rawSamples[7].toSpec(framework);
SampleSpec formSpec(String framework) => rawSamples[8].toSpec(framework);
SampleSpec simpleTextSpec(String framework) => rawSamples[9].toSpec(framework);
SampleSpec interactiveButtonSpec(String framework) =>
    rawSamples[10].toSpec(framework);
SampleSpec loginFormSpec(String framework) => rawSamples[11].toSpec(framework);
SampleSpec weatherSpec(String framework) => rawSamples[12].toSpec(framework);
...
SampleSpec creditCardSpec(String framework) => rawSamples[20].toSpec(framework);
...
SampleSpec rowLayoutSpec(String framework) => rawSamples[29].toSpec(framework);
...
SampleSpec trackListSpec(String framework) => rawSamples[33].toSpec(framework);
...
SampleSpec signInSpec(String framework) => rawSamples[40].toSpec(framework);
