...
widget Root = Column(gap: 6.0, crossAxisAlignment: "start", children: [
  ...
  SizedBox(height: 8.0),
  Text(text: "Box decoration · cornerRadius + border + elevation (opt-in)", variant: "caption"),
  Row(gap: 10.0, crossAxisAlignment: "center", children: [
    Box(padding: 10.0, cornerRadius: 10.0, border: 1.0,
      child: Text(text: "outline")),
    Box(padding: 10.0, cornerRadius: 10.0, color: "#331A73E8", elevation: 3.0,
      child: Text(text: "raised")),
    Box(padding: 10.0, cornerRadius: 999.0,
      border: { width: 2.0, color: "#1A73E8" }, child: Text(text: "pill")),
  ]),
  SizedBox(height: 8.0),
