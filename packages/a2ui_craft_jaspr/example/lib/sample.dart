...
abstract class Sample extends StatefulComponent {
...
class _SampleState extends State<Sample> {
  ...
  void initState() {
    ...
    _runtime = Runtime()
      ...
      ..update(_catalogName, parseLibraryFile(component.catalogSource));
    _processor =
        MessageProcessor<ComponentApi>(catalogs: [component.buildCatalog()]);
    _processor.processMessages(component.buildMessages());
  ...
  void _onAction(A2uiClientAction action) {
    component.onAction(action, SampleHost._(_processor, _surface));
  }
